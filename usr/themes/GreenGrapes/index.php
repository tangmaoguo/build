...
<div id="m-container" class="container">
 ...
 <span><i class="fa fa-comment"></i> <span id = "sourceId::<?php echo $this->cid;echo $this->date('ymdhis')?>" class = "cy_cmt_count" ></span>条评论
<script id="cy_cmt_num" src="https://changyan.sohu.com/upload/plugins/plugins.list.count.js?clientId=cytEt3nmb">
</script></span>
